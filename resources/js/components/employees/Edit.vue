                    ...
                    <div class="card-body">
                        <form @submit.prevent="updateEmployee()">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" v-model="form.firstname" type="text" class="form-control" name="firstname" autocomplete="firstname" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="zipcode" v-model="form.zipcode" type="text" class="form-control" name="zipcode" value="" autocomplete="zipcode" autofocus>
                                    <span class="invalid-feedback" role="alert">
                                        <strong></strong>
                                    </span>
                                </div>
    ...
    methods: {
        ...
        updateEmployee() {
            axios.put(`/api/employees/${this.$route.params.id}`, {
                ...
                birthdate: moment(this.form.birthdate).format('YYYYMMDD'),
                date_hired: moment(this.form.date_hired).format('YYYYMMDD'),
                department_id: this.form.department_id,
            }).then(response => this.$router.push({name: 'EmployeesIndex', params: {success: true}}))
                .catch(error => console.log(error));
        },
        getEmployee() {
